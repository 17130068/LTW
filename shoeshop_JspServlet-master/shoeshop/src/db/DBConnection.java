...
//		return con;
		 public static ConnectionPool pool;
		    ...
		    public static Connection createConnection() throws ClassNotFoundException, SQLException, SQLException {
		        Connection con = null;
		        if (pool == null) {
//		            pool = BasicConnectionPool.create("jdbc:mysql://localhost:3306/LTW?useUnicode=true&amp;characterEncoding=utf8", "root", "123456");
		            pool = BasicConnectionPool.create("jdbc:mysql://localhost:3306/ltw", "root", "123456");
		        }
